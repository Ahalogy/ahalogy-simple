...
if (displayCardedContent) {
  ...
  console.log("Appending scripts and stylesheet");
  // Add js libraries
  $("head")
    .append("<link rel='stylesheet' href='styles/app.css'/>")
    .append("<script type='text/javascript' src='js/skrollr.min.js'></script>")
    .append("<script type='text/javascript' src='js/hammer.js'></script>")
    .append("<script type='text/javascript' src='js/app.js'></script>");
